...
def get_parser() -> argparse.ArgumentParser:
    # data_path = '/home/jaume/Desktop/Data/Urblauna_SFTP/UKB_Cardiac_BIDS/derivatives/'
...
def main():
    ...
    classifiers = [
        ...
        xgb.XGBClassifier(eval_metric='logloss', learning_rate=0.05, n_jobs=4),
